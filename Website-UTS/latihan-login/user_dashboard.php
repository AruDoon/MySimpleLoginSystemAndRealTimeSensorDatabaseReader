...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cards-row { display: flex; justify-content: space-around; width: 100%; max-width: 1350px; margin-bottom: 30px; gap: 20px; }
        ...
        .card h3 { color: #FFD700; margin-bottom: 10px; text-shadow: 1px 1px 2px rgba(0,0,0,0.8); font-size: 24px; }
        ...
        .biodata-label { font-size: 17px; color: #FFD700; text-align: left; min-width: 50%; padding-right: 10px; }
        .biodata-value { font-size: 17px; color: #fff; text-align: right; min-width: 50%; font-weight: bold; }
        .card p { color: #fff; margin: 5px 0; font-size: 14px; }
        .card .clock { font-size: 40px; font-weight: bold; color: #FFD700; }
        .card .date { font-size: 20px; color: #fff; }
        ...
        /* Side-by-side info section dari css lama */
        .info-section { display: flex; width: 100%; max-width: 1350px; gap: 20px; margin: 30px auto; }
        ...
        .explanation-card { flex: 1; background: rgba(0, 0, 0, 0.6); backdrop-filter: blur(10px); max-width: 1350px; padding: 30px; border-radius: 15px; box-shadow: 0 8px 32px rgba(0,0,0,0.5); border: 2px solid rgba(255,215,0,0.2); transition: all 0.3s ease; }
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="explanation-card">
                ...
                <div class="biodata-separator"></div>
                <div class="robot-image">
                    <img src="../F1Poster.png" alt="Robot Hexapod BARELANG F1"> <!-- Use your hexapod image file -->
                </div>
