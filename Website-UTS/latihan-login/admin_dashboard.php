...
<body>
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button onclick="showEditForm(<?php echo $u['id']; ?>, '<?php echo addslashes($u['nama']); ?>', '<?php echo addslashes($u['jurusan']); ?>', '<?php echo addslashes($u['prodi']); ?>', '<?php echo addslashes($u['address']); ?>', '<?php echo addslashes($u['phone']); ?>')" style="width: 80px;"><strong>EDIT</strong></button>
                                ...
                                <form method="POST" style="display:inline;" onsubmit="return confirm('Hapus user?');">
                                    ...
                                    <button type="submit" style="background:#f44336; width: 80px;">Hapus</button>
                                </form>
                            </td>
                        </tr>
                        <?php endforeach; ?>
            ...
            <section class="content-card" id="editForm" style="display:none;">
                <h2>Edit User</h2>
                <form method="POST">
                    <input type="hidden" name="edit_id" id="edit_id">
                    <input type="text" name="nama" id="edit_nama" placeholder="Nama" required>
                    <input type="text" name="jurusan" id="edit_jurusan" placeholder="Jurusan" required>
                    <input type="text" name="prodi" id="edit_prodi" placeholder="Prodi" required>
                    <input type="text" name="address" id="edit_address" placeholder="Alamat" required>
                    <input type="tel" name="phone" id="edit_phone" placeholder="Telepon" required>
                    <button type="submit">Update</button>
                    <button type="button" onclick="hideEditForm()" style="background:#f44336;">Batal</button>
                </form>
            </section>

            <!-- Add User Form (Hidden by default, shown via button) -->
            <section class="content-card" id="addForm" style="display:none;">
                ...
                <form method="POST">
                    ...
                    <button type="submit" onclick="hideAddForm()" style="background:#f44336;">Batal</button>
                </form>
            </section>

            <!-- Add User Button -->
            <section class="content-card">
                <button onclick="showAddForm()" style="width:100%; padding:15px; font-size:16px; background:#4CAF50;">
                    ➕ Tambah User Baru
                </button>
            </section>
        </main>
    ...
    <script>
        function showEditForm(id, nama, jurusan, prodi, address, phone) {
